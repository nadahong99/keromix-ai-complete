...
void KeroMixAIAudioProcessorEditor::paint(juce::Graphics& g)
{
    ...
    // Fix: SPECTRUM section repositioned to sit cleanly below PATCHES
    g.fillRoundedRectangle(rightX, dspY + 262.f, rightW, 58.f, 8.f);
    g.setColour(kGreen.withAlpha(0.4f));
    g.setFont(juce::Font(9.f, juce::Font::bold));
    g.drawText("SPECTRUM", (int)rightX + 10, (int)(dspY + 266), 65, 12, juce::Justification::left, false);

    float bW = 22.f, bH = 34.f, bY = dspY + 267.f;
