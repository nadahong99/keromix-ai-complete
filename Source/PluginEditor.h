...
private:
    ...
    // Per-bin smoothed spectrum for analyser
    float spectrumSmooth[FFT_SIZE / 2] = {};
    // Level + GR metering
    float levelL = -90.f, levelR = -90.f;
    float peakL  = -90.f, peakR  = -90.f;
    float peakHoldTimer = 0.f;
    float grMeterSmooth = 0.f;
    ...
    void drawMonitorSection(juce::Graphics& g, juce::Rectangle<float> area);
